...
<body>
    ...
    <div class="container content-main mt-5">
        ...
        <div class="row justify-content-center text-center my-4">
            <div class="col-12">
                ...
                <input type="number" id="cantidadDados" value="1" min="1" max="6" class="form-control" placeholder="Cantidad de Dados">
            </div>
        </div>
   ...
   <!-- Botón para ver el historial -->
        <div class="row justify-content-center text-center my-4">
            <div class="col-12">
                <a href="../juegosDados/historial.php" class="btn btn-info">Ver Historial</a>
            </div>
        </div>
    </div>
...
<!-- Main JS -->
        <script src="../juegosDados/js/num-aleatorio.js"></script>
        <script src="../juegosDados/js/audio.js"></script>
